export const abi_ProjectLucifer = [
  {
    inputs: [
      { internalType: "string", name: "newBaseURI", type: "string" },
      { internalType: "address", name: "acAddress", type: "address" },
      { internalType: "address", name: "ssdAddress", type: "address" },
    ],
  ...
  {
    inputs: [
      { internalType: "uint256[]", name: "_ownedACTokens", type: "uint256[]" },
      { internalType: "uint256[]", name: "_ownedSSDTokens", type: "uint256[]" },
    ],
    name: "claimTokens",
    outputs: [],
    stateMutability: "nonpayable",
